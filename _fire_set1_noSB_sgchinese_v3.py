...
def submit():
    ...
    print(f"Submitting set 1 v3 — shot 2 6s no-ponytail, shot 6 2s silent reaction:")
...
def main():
    ...
    local_path = local / "set-01-noSB-sgchinese-v3-480p-15s.mp4"
    ...
    fname = "set-01-noSB-sgchinese-v3-480p-15s.mp4"
    ...
    Path("/tmp/set1_noSB_v3_result.json").write_text(json.dumps({
