...
Location: Grace's Home Studio. Twin-monitor desk, monstera plants, bamboo blinds half-drawn. See attached blocking reference for staging — Grace at her desk, Daniel beside her at the corner of the desk.

Lighting / time of day: NIGHT. Only the desk lamp and monitor glow lighting the room. Dark beyond the windows. Warm pools of light around the desk; rest of studio in shadow.
...
2, 6s, CU, Static, Close-up of Grace., GRACE：(轻声) 我知道。 (Singapore Chinese accent) (Quiet; eyes still down), Quiet ambience. She turns slightly toward the studio window. Brief cutaway of Daniel listening to her. GRACE：(望向窗外) 我离开大公司是想自己做。但是每一件事都是一份全职工作。我只有一个人。 (Singapore Chinese accent) (Looking out window; voice tired, not bitter), Faint city hum; quiet ambience.

3, 4s, OTS, Static, OTS over Grace's shoulder onto Daniel (medium close-up framing). He seats himself down at the corner of the desk. DANIEL：你在大公司 —— 没在扛七份工作。 (Singapore Chinese accent) (Quiet; eyes meet hers; mouth soft), Faint city hum.

4, 2s, CU, Static, Close-up of Grace. She reflects., (Eyes glaze; small breath), Quiet — holds on the breath."""

REFS = [
    {"type": "video", "url": "asset://asset-20260516234440-d5bdp", "label": "BLOCKING REF (Daniel Studio 15s)"},
]
...
def submit():
    ...
    print(f"Submitting Daniel home-studio CLOSER v5 NIGHT (4 shots, 15s → 15s):")
...
def main():
    ...
    local_path = local / "set-04-daniel-studio-closer-v5-night-15s-480p.mp4"
    ...
    fname = "daniel-studio-closer-v5-night-15s-480p.mp4"
    ...
    Path("/tmp/daniel_studio_closer_v5_result.json").write_text(json.dumps({
