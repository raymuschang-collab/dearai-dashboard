#!/usr/bin/env python3
"""Upload trimmed 4s transformation+Saturday segment as blocking ref for sets 10-11."""
import os, sys
...
LOCAL_MP4 = "/Users/raymuschang/Downloads/transformation_blocking_11to15s.mp4"
ASSET_NAME = "blocking references (Transformation + Saturday)"
...
def main():
    ...
    f = drive.files().create(
        body={"name": "transformation-saturday-blocking-11to15s-4s.mp4", "parents": [refs_folder]},
    ...
    new_row = [ASSET_NAME, "LOCATIONS", aid, drive_view, "video", "Uploaded", ts, "Set 10/11"]
    ...
    print(f"Duration:   4s (trimmed from 11s-15s segment)")
