...
def submit():
    ...
    print(f"Submitting Daniel home-studio CLOSER v4 REFINED (4 shots, 15s → 15s):")
...
def main():
    ...
    local_path = local / "set-04-daniel-studio-closer-v4-refined-15s-480p.mp4"
    ...
    fname = "daniel-studio-closer-v4-refined-15s-480p.mp4"
    ...
    Path("/tmp/daniel_studio_closer_v4_result.json").write_text(json.dumps({
