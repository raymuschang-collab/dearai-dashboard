...
def submit():
    ...
    print(f"Submitting traveling-Graces 12s montage:")
...
def main():
    ...
    local_path = local / "set-12-traveling-graces-12s-480p.mp4"
    ...
    fname = "traveling-graces-12s-480p.mp4"
    ...
    Path("/tmp/traveling_graces_12s_result.json").write_text(json.dumps({
