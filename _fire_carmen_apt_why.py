...
def submit(duration):
    ...
    print(f"Submitting Carmen apt why-it-works (compressed) (duration={duration}s):")
...
def main():
    ...
    local_path = local / f"set-06-carmen-apt-why-condensed-{chosen_dur}s-480p.mp4"
    ...
    fname = f"carmen-apt-why-condensed-{chosen_dur}s-480p.mp4"
