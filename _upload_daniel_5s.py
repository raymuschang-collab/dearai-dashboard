#!/usr/bin/env python3
"""Upload DANIEL_5s (4.9s trimmed Daniel v2) to BytePlus + Asset Library."""
import os, sys
...
LOCAL_MP4 = "/Users/raymuschang/Downloads/DANIEL_5s.mp4"
ASSET_NAME = "DANIEL LIM_5s"
BIBLE_NAME = "DANIEL LIM"
...
def main():
    ...
    f = drive.files().create(
        body={"name": "DANIEL_5s.mp4", "parents": [refs_folder]},
    ...
    new_row = [
        BIBLE_NAME, "CHARACTERS", aid, drive_view, "video", "Uploaded", ts, "Set 10/11",
    ]
