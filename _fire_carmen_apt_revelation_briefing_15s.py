...
def submit(duration):
    ...
    print(f"Submitting Carmen apt revelation + daily briefing (15s) (duration={duration}s):")
...
def main():
    ...
    local_path = local / f"set-06-carmen-apt-revelation-briefing-15s-{chosen_dur}s-480p.mp4"
    ...
    fname = f"carmen-apt-revelation-briefing-15s-{chosen_dur}s-480p.mp4"
