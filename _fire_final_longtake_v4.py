...
def submit():
    ...
    print(f"Submitting final long take v4 (new cropped laptop screen):")
...
def main():
    ...
    local_path = local / "set-12-final-longtake-v4-trimmed-vo-480p-15s.mp4"
    ...
    fname = "final-longtake-v4-trimmed-vo-480p-15s.mp4"
    ...
    Path("/tmp/final_longtake_v4_result.json").write_text(json.dumps({
