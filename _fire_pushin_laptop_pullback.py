...
def submit():
    ...
    print(f"Submitting push-in to laptop + pullback (8s, 2 shots):")
...
def main():
    ...
    local_path = local / "set-12-pushin-laptop-pullback-8s-480p.mp4"
    ...
    fname = "pushin-laptop-pullback-8s-480p.mp4"
    ...
    Path("/tmp/pushin_laptop_pullback_result.json").write_text(json.dumps({
