#!/usr/bin/env python3
"""Fire Carmen apartment batch A v2 — side-by-side blocking, screen demo.
Grace in cream blouse (changed from blue tank). 5 shots 20s → 15s output."""
...
Wardrobe: Carmen wears a black sleeveless tank. Grace wears a cream-coloured blouse.

1, 4s, WS, Static, Wide INT of Carmen's apartment dining area — Carmen and Grace seated side-by-side at one side of the wooden dining table, sharing one corner. Carmen's MacBook open in front of her, second MacBook closed beside it, two mugs of tea, brass pendant lamp overhead, framed photograph on the cream wall, low bookshelf behind. Grace has leaned in, her shoulder near Carmen's, both looking at Carmen's screen. Warm Sunday afternoon light through bamboo blinds., (Grace's posture: leaned in toward Carmen's screen, attentive; Carmen: settled, calm, one hand on her laptop), Apartment ambient; teacups; soft piano under.

2, 3s, MS, Static, Medium shot of Carmen and Grace side-by-side, Carmen on the right, Grace on the left leaning into Carmen's shoulder. Carmen's left hand rests on the MacBook keyboard; she turns slightly toward Grace., CARMEN：我用 Claude。三种用法。 (Singapore Chinese accent) (Eyes flick to Grace; small confident half-smile; mouth neutral), Apartment ambient.

3, 3s, CU, Static, Close-up of Grace looking at Carmen's screen over Carmen's shoulder. One eyebrow lifts, lips pressed., GRACE：那个 AI。 (Singapore Chinese accent) (Eyebrow lifts; lips press; eyes on the screen), Apartment ambient.

4, 7s, MS, Static, Medium shot of Carmen and Grace side-by-side at the MacBook. Carmen gestures toward her screen with her right hand, walking Grace through the three cases — Grace's eyes follow Carmen's hand to the screen, then back to Carmen's face., CARMEN：Sea Group 那个案子 —— 初稿三十分钟。Hoyo 新品牌 —— 四十五分钟,五个切入点,他们选了其中一个。还有 newsletter,cold pitch 邮件,LinkedIn,一个礼拜一到二个钟,全部搞定。 (Singapore Chinese accent) (Right hand gestures at the screen with each case; eyes steady; quiet confidence; Grace tracks the hand), Apartment ambient.

5, 3s, CU, Static, Close-up of Grace — eyes still on Carmen's screen. Quiet, beginning to process the scale., GRACE：全部。 (Singapore Chinese accent) (Eyebrows draw together; mouth slightly open; eyes on screen), Apartment ambient."""
...
def submit():
    ...
    print(f"Submitting Carmen apartment batch A v2 (side-by-side, cream blouse, 5 shots 20s → 15s):")
...
def main():
    ...
    local_path = local / "set-06-carmen-apartment-batchA-v2-sidebyside-480p-15s.mp4"
    ...
    fname = "carmen-apartment-batchA-v2-sidebyside-480p-15s.mp4"
    ...
    Path("/tmp/carmen_apartment_batchA_v2_result.json").write_text(json.dumps({
