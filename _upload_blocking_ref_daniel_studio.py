#!/usr/bin/env python3
"""Upload daniel-studio-batchABC-9shot-480p-15s.mp4 as a blocking+face reference."""
import os, sys
...
LOCAL_MP4 = "/Users/raymuschang/Downloads/daniel-studio-batchABC-9shot-480p-15s.mp4"
...
def main():
    ...
    f = drive.files().create(
        body={"name": "daniel-studio-blocking-9shot-15s.mp4", "parents": [refs_folder]},
    ...
    new_row = [
        ...
        "LOCATIONS",       # B: Bible Tab (blocking + location anchor)
        aid,               # C: Asset Code
