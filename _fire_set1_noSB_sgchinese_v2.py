...
def submit():
    ...
    print(f"Submitting set 1 v2 (re-roll) — NO storyboard ref, Singapore Chinese accent:")
...
def main():
    ...
    local_path = local / "set-01-noSB-sgchinese-v2-480p-15s.mp4"
    ...
    fname = "set-01-noSB-sgchinese-v2-480p-15s.mp4"
    ...
    Path("/tmp/set1_noSB_sgchinese_v2_result.json").write_text(json.dumps({
