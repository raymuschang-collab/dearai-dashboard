#!/usr/bin/env python3
"""Fire Carmen apartment — 4-shot trim (1-4 only). 17s → 15s, milder compression.
Side-by-side blocking, Grace cream blouse."""
...
def submit():
    ...
    print(f"Submitting Carmen apartment 4-shot trim (17s → 15s, mild compression):")
...
def main():
    ...
    local_path = local / "set-06-carmen-apartment-4shot-trim-480p-15s.mp4"
    ...
    fname = "carmen-apartment-4shot-trim-480p-15s.mp4"
    ...
    Path("/tmp/carmen_apartment_4shot_result.json").write_text(json.dumps({
