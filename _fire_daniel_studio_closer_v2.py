#!/usr/bin/env python3
"""Fire Daniel home-studio CLOSER v2 (Daniel standing) — 4 shots, 13s → 15s output.
...
1, 3s, MCU, Static, Medium close-up of Daniel — he is STANDING beside the desk., DANIEL：阿嬷生日礼拜天。 (Singapore Chinese accent) (Soft statement, not a question; eyes on Grace), Quiet ambience.
...
def submit():
    ...
    print(f"Submitting Daniel home-studio CLOSER v2 (Daniel standing) (4 shots, 13s → 15s):")
...
def main():
    ...
    local_path = local / "set-04-daniel-studio-closer-v2-standing-15s-480p.mp4"
    ...
    fname = "daniel-studio-closer-v2-standing-15s-480p.mp4"
    ...
    Path("/tmp/daniel_studio_closer_v2_result.json").write_text(json.dumps({
