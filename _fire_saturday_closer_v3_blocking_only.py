...
REFS = [
    {"type": "video", "url": "asset://asset-20260516235138-v6bcl", "label": "BLOCKING REF (Saturday 4s, all-in-one)"},
]
...
def submit():
    ...
    print(f"Submitting Saturday morning closer v3 BLOCKING-ONLY (5 shots, 13s → 15s):")
...
def main():
    ...
    local_path = local / "set-11-saturday-closer-v3-blockingonly-15s-480p.mp4"
    ...
    fname = "saturday-closer-v3-blockingonly-15s-480p.mp4"
    ...
    Path("/tmp/saturday_closer_v3_result.json").write_text(json.dumps({
