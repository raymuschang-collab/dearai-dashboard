...
3, 5s, OTS, Static, OTS over Grace's shoulder onto Daniel (medium close-up framing). He seats himself down at the corner of the desk., DANIEL：你在大公司 —— 没在扛七份工作。 (Singapore Chinese accent) (Quiet; eyes meet hers; mouth soft), Faint city hum.
...
def submit():
    ...
    print(f"Submitting Daniel CLOSER 720p HERO — shots 3-4 only (7s → 8s):")
...
def main():
    ...
    local_path = local / "set-04-daniel-closer-shot3-4-720p-8s.mp4"
    ...
    fname = "daniel-closer-shot3-4-720p-8s.mp4"
    ...
    Path("/tmp/daniel_closer_shot3_4_720p_result.json").write_text(json.dumps({
