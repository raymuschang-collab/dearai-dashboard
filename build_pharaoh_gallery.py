#!/usr/bin/env python3
"""
Read all bible tabs from the Strike! Pharaoh King sheet and compose a
self-contained HTML gallery (pharaoh_king_gallery.html) with a sandy /
parchment / terracotta palette.

Re-runnable: every run regenerates the HTML from current sheet state.
"""
...
def main():
    ...
    # === STORYBOARDS ===
    # Living-doc schema: globals in rows 1-8, headers row 10, data row 11+
...
<div class="wrap">
  ...
  <footer>The Producer's Codex · Static gallery · Refresh by re-running build_pharaoh_gallery.py</footer>
</div>
