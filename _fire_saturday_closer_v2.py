...
def submit():
    ...
    print(f"Submitting Saturday morning closer v2 (5 shots, 13s → 15s):")
...
def main():
    ...
    local_path = local / "set-11-saturday-closer-v2-15s-480p.mp4"
    ...
    fname = "saturday-closer-v2-15s-480p.mp4"
    ...
    Path("/tmp/saturday_closer_v2_result.json").write_text(json.dumps({
